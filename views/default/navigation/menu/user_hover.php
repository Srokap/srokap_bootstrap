...
echo '<ul class="dropdown-menu elgg-menu elgg-menu-hover">';
...
if (elgg_is_logged_in() && $actions) {
	...
	echo elgg_view('navigation/menu/elements/section', array(
		'class' => "nav elgg-menu elgg-menu-hover-actions",
		'items' => $actions,
	));
	echo '</li>';
}
...
if ($main) {
	...
	echo elgg_view('navigation/menu/elements/section', array(
		'class' => 'nav elgg-menu elgg-menu-hover-default',
		'items' => $main,
	));
...
if (elgg_is_admin_logged_in() && $admin) {
	...
	echo elgg_view('navigation/menu/elements/section', array(
		'class' => 'nav elgg-menu elgg-menu-hover-admin',
		'items' => $admin,
	));
